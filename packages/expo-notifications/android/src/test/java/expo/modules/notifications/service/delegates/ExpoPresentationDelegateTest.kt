...
class ExpoPresentationDelegateTest {
  ...
  // Round-trips through Parcel: ExpoNotificationBuilder marshalls the request into the posted
  // notification's extras, and ExpoPresentationDelegate.getNotification() unmarshalls it back.
